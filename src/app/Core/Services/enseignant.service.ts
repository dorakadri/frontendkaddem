...
export class EnseignantService {
  ...
  public urlGetById =
    environment.url + "controllerEnseignant/DisplayEnseignantById/";
  public urlAdd = environment.url + "controllerEnseignant/ajouterEnseignant/";
  public urlUpdate =
    environment.url + "controllerEnseignant/updateEnseignantById/";
  ...
  public assignEnseignantsToDepartment(idenseignant: number, idDepart: number) {
    return this.http.put(
      `${this.url}assignEnseignantToDepartement/${idenseignant}/${idDepart}`,
      {}
    );
  }
}
