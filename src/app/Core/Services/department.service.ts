...
export class DepartementService {
  public urlGET =
    environment.url + "DepartmentController/displayalldepartment/";
  public urlDel = environment.url + "DepartmentController/deleteDepartment/";
  public urlGetById =
    environment.url + "DepartmentController/displdepartmentbyid/";
  ...
  public urlNbensperdepartById =
    environment.url + "DepartmentController/GetNbensperDepartment/";
