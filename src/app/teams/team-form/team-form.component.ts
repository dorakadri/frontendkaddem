...
export class TeamFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (id != null) {
      ...
      this.teamService.getTeamByID(id).subscribe((object: Team) => {
        ...
        if (this.team.equipedetail != null) {
          ...
          this.teamForm
            .get("equipedetail")
            .get("salle")
            .setValue(this.team.equipedetail.salle);
          this.teamForm
            .get("equipedetail")
            .get("thematique")
            .setValue(this.team.equipedetail.thematique);
        }
  ...
  onSubmit() {
    if (this.action == "Add") {
      ...
      this.teamService
        .updateTeam(this.teamForm.value)
